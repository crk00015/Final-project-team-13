...
def _(Data, pl, px):
    ...
    Fig1 = px.bar(
        ...
        title = "Top 10 Average Game Sales Per Developer"
    )
    Fig1.update_layout(
...
def _(DF1_Filt, pl, px):
    ...
    Fig1_TOT = px.bar(
        ...
        title = "Top 10 Total Sales Per Developer"
    )
...
def _(Data, pl, px):
    ...
    Fig2 = px.bar(
        ...
        title = "Top 10 Average Critic Scores Per Developer"
    )
    Fig2.update_layout(
        xaxis_title="Developer",
        yaxis=dict(range=[9.4, 10])
    )
    Fig2
...
def _(DF2_Filt, pl, px):
    ...
    Fig2_5 = px.bar(
        ...
        x = "developer",
        y = "Average Critic Score",
        title = "Top 10 Average Critic Scores Per Developer With More Than 5 Entries"
    )
    Fig2_5.update_layout(
        xaxis_title="Developer",
        yaxis=dict(range=[8.8, 9.2])
    )
    Fig2_5
    return DF2_5, Fig2_5
